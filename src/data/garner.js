    ...
    phases: [
      {
        ...
        permits: [
          { icon: 'map', name: 'Lot survey & site plan', desc: 'Sealed site plan required showing building footprint and distances to all property lines. File with Wake County Register of Deeds.', jurisdiction: 'county', time: '1–2 wks', url: 'https://www.wakegov.com/departments-government/register-of-deeds', warn: false },
