        ...
        permits: [
          {
            ...
            jurisdiction: 'county',
            time: '1–2 wks',
            detailsUrl: 'https://www.wake.gov/departments-government/register-deeds',
            applyUrl: 'https://www.wake.gov/departments-government/register-deeds',
          ...
          },
          {
            ...
            jurisdiction: 'city',
            time: '1–3 days',
            detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com',
            portal: null, warn: false,
          },
        ],
      },
        ...
        permits: [
          {
            ...
            time: 'After approval',
            detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits',
          ...
          },
          {
            ...
            jurisdiction: 'state',
            time: '1 day',
            detailsUrl: 'https://www.liensnc.com',
    ...
    phases: [
      {
        ...
        permits: [
          { icon: 'zoom-check', name: 'Zoning eligibility check', desc: 'Confirm your lot qualifies for an ADU under Apex UDO. Contact Planning at (919) 249-3300.', jurisdiction: 'city', time: '1–3 days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: null, warn: false },
        ],
      },
      {
        label: 'Building permits (IDT Plans)',
        permits: [
          { icon: 'home', name: 'Residential building permit', desc: 'Submit through IDT Plans portal. Detached ADUs treated as single-family dwelling.', jurisdiction: 'city', time: '1–10 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Submit through IDT Plans portal.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'droplet', name: 'Plumbing permit', desc: 'Required if ADU includes kitchen or bathroom. Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'certificate', name: 'Certificate of occupancy', desc: 'Required before ADU can be rented or occupied.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits', portal: 'ePermits', warn: false },
        ],
      },
    ],
  },
    ...
    phases: [
      {
        ...
        permits: [
          { icon: 'tools', name: 'Residential building permit - deck / porch', desc: 'Submit through IDT Plans portal. Allow 1–10 working days for review.', jurisdiction: 'city', time: '1–10 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Required if adding lighting or outlets. Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits (IDT Plans)',
        permits: [
          { icon: 'ripple', name: 'Swimming pool / spa permit', desc: 'Submit through IDT Plans portal.', jurisdiction: 'city', time: '1–10 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Pool bonding, pump, and lighting. Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'barrier-block', name: 'Barrier / fence permit', desc: 'NC code requires approved safety barrier around all pools.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits',
        permits: [
          { icon: 'home-2', name: 'Accessory structure permit', desc: 'Required for structures over 144 sq ft or 12 ft tall. Submit through IDT Plans.', jurisdiction: 'city', time: '1–5 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Building permits (IDT Plans)',
        permits: [
          { icon: 'layout-sidebar-right-expand', name: 'Residential building permit', desc: 'Submit through IDT Plans portal. Required for structural changes and additions.', jurisdiction: 'city', time: '1–10 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'If scope includes electrical modifications.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'droplet', name: 'Plumbing permit', desc: 'If scope includes plumbing modifications.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'certificate', name: 'Certificate of occupancy', desc: 'Required if addition creates new occupiable space.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits', portal: 'ePermits', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Before you apply',
        permits: [
          { icon: 'map', name: 'Lot survey & recorded plat', desc: 'Sealed plot plan required. File with Wake County Register of Deeds.', jurisdiction: 'county', time: '1–2 wks', detailsUrl: 'https://www.wake.gov',
            applyUrl: 'https://www.wake.gov', portal: null, warn: false },
          { icon: 'building-community', name: 'Zoning / planning approval', desc: 'Multi-unit may require Board of Adjustment review. Contact Apex Planning at (919) 249-3300.', jurisdiction: 'city', time: '10–20 days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
      {
        label: 'Building permits (IDT Plans)',
        permits: [
          { icon: 'home', name: 'Residential building permit (per unit)', desc: 'Submit through IDT Plans. Each unit may require separate permit.', jurisdiction: 'city', time: '1–10 working days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'bolt', name: 'Electrical permit (per unit)', desc: 'Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'droplet', name: 'Plumbing permit (per unit)', desc: 'Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
          { icon: 'wind', name: 'Mechanical / HVAC permit (per unit)', desc: 'Submit through IDT Plans.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.myidtplans.com', portal: 'IDT Plans', warn: false },
        ],
      },
      {
        ...
        permits: [
          { icon: 'credit-card', name: 'Permit fee payment', desc: 'Pay all fees through ePermits portal after IDT approval. Permit not active until paid.', jurisdiction: 'city', time: 'After approval', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits', portal: 'ePermits', warn: true },
          { icon: 'receipt', name: 'Lien agent appointment', desc: 'Required - townhouse always exceeds $40,000. File at liensnc.com.', jurisdiction: 'state', time: '1 day', detailsUrl: 'https://www.liensnc.com',
            applyUrl: 'https://www.liensnc.com', portal: null, warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'clipboard-check', name: 'Construction inspections', desc: 'Schedule by 2 PM day before via online form or (919) 249-3388. Wake County performs inspections.', jurisdiction: 'county', time: 'Throughout', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits', portal: null, warn: false },
          { icon: 'certificate', name: 'Certificate of occupancy (per unit)', desc: 'Issued after all inspections pass. Required before occupancy.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.apexnc.org/596/Obtaining-A-Building-Permit',
            applyUrl: 'https://www.apexnc.org/183/Building-Inspections-Permits', portal: 'ePermits', warn: false },
        ],
      },
    ],
