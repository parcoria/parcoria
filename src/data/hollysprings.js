    ...
    phases: [
      {
        ...
        permits: [
          ...
          },
          {
            ...
            jurisdiction: 'city',
            time: '1–3 days',
            detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal',
            warn: false,
          },
        ],
      },
    ...
    phases: [
      {
        ...
        permits: [
          { icon: 'zoom-check', name: 'Zoning eligibility check', desc: 'Confirm lot qualifies for ADU under Holly Springs UDO. Email DSPermitting@hollyspringsnc.gov.', jurisdiction: 'city', time: '1–3 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        label: 'Permits (CityView)',
        permits: [
          { icon: 'home', name: 'Residential building permit', desc: 'Apply through CityView Portal. Detached ADUs treated as single-family dwelling.', jurisdiction: 'city', time: '5–15 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Apply through CityView Portal.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'droplet', name: 'Plumbing permit', desc: 'Required if ADU includes kitchen or bathroom.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'certificate', name: 'Certificate of occupancy', desc: 'Required before ADU can be rented or occupied.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits (CityView)',
        permits: [
          { icon: 'tools', name: 'Residential building permit - deck / porch', desc: 'Apply through CityView Portal or email DSPermitting@hollyspringsnc.gov.', jurisdiction: 'city', time: '5–10 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Required if adding lighting or outlets.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits (CityView)',
        permits: [
          { icon: 'ripple', name: 'Swimming pool / spa permit', desc: 'Apply through CityView Portal. Required for all in-ground and above-ground pools over 24 inches.', jurisdiction: 'city', time: '5–10 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'Pool bonding, pump, and lighting. Progress Energy premise number required for final.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'barrier-block', name: 'Barrier / fence permit', desc: 'NC code requires approved safety barrier around all pools.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits',
        permits: [
          { icon: 'home-2', name: 'Accessory structure permit', desc: 'Required for structures over 144 sq ft or 12 ft tall. Apply through CityView Portal.', jurisdiction: 'city', time: '3–5 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Permits (CityView)',
        permits: [
          { icon: 'layout-sidebar-right-expand', name: 'Residential building permit', desc: 'Apply through CityView Portal. Required for structural changes and additions.', jurisdiction: 'city', time: '5–15 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'bolt', name: 'Electrical permit', desc: 'If scope includes electrical modifications.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'droplet', name: 'Plumbing permit', desc: 'If scope includes plumbing modifications.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'certificate', name: 'Certificate of occupancy', desc: 'Required if addition creates new occupiable space.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Before you apply',
        permits: [
          { icon: 'map', name: 'Lot survey & plot plan', desc: 'Sealed survey required. File with Wake County Register of Deeds.', jurisdiction: 'county', time: '1–2 wks', detailsUrl: 'https://www.wake.gov',
            applyUrl: 'https://www.wake.gov', warn: false },
          { icon: 'building-community', name: 'Zoning compliance review', desc: 'Multi-unit residential requires UDO compliance review. May require Board of Adjustment approval.', jurisdiction: 'city', time: '10–20 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        ...
        permits: [
          { icon: 'home', name: 'Residential building permit (per unit)', desc: 'Apply through CityView Portal. Each unit may require separate permit.', jurisdiction: 'city', time: '5–15 working days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'bolt', name: 'Electrical permit (per unit)', desc: 'Apply through CityView Portal.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'droplet', name: 'Plumbing permit (per unit)', desc: 'Apply through CityView Portal.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'wind', name: 'Mechanical / HVAC permit (per unit)', desc: 'Apply through CityView Portal.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        ...
        permits: [
          { icon: 'droplets', name: 'Water & sewer connection', desc: 'Contact Holly Springs Public Utilities at (919) 557-2591 early - connection timelines vary.', jurisdiction: 'city', time: '5–10 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          ...
          { icon: 'fire-extinguisher', name: 'Fire code compliance review', desc: 'Multi-unit triggers fire separation and egress review.', jurisdiction: 'city', time: 'Concurrent', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
      {
        label: 'Completion',
        permits: [
          { icon: 'clipboard-check', name: 'Construction inspections', desc: 'Request through CityView Portal or call 311. Before 4 PM = next day. After 4 PM = second business day.', jurisdiction: 'county', time: 'Throughout', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
          { icon: 'certificate', name: 'Certificate of occupancy (per unit)', desc: 'All fees must be paid before CO issued. Required before occupancy.', jurisdiction: 'city', time: '3–5 days', detailsUrl: 'https://www.hollyspringsnc.gov/1064/Permits',
            applyUrl: 'https://cityview.hollyspringsnc.us/portal', warn: false },
        ],
      },
    ],
