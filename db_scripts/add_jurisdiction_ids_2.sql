...
-- Also add jurisdiction_ids to the contractors table (developer's contractor network)
ALTER TABLE contractors
ADD COLUMN IF NOT EXISTS jurisdiction_ids JSONB DEFAULT '{}';

COMMENT ON COLUMN contractors.jurisdiction_ids IS
  'Jurisdiction-specific portal IDs for this contractor. Durham stores CID (e.g. {"durham": "12345"}). Others store "registered".';
